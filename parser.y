...
%token TOKEN_ASSIGN TOKEN_PLUS TOKEN_MINUS TOKEN_MULT TOKEN_DIV TOKEN_EQ 
%token TOKEN_LT TOKEN_GT TOKEN_LE TOKEN_GE TOKEN_LPAREN TOKEN_RPAREN TOKEN_SEMI 
%token TOKEN_COMMA TOKEN_COLON TOKEN_DOT
