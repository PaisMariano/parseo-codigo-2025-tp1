...
{
  "$end", "error", "$undefined", "TOKEN_CLASS", "TOKEN_CREATE",
  "TOKEN_FEATURE", "TOKEN_DO", "TOKEN_END", "TOKEN_IF", "TOKEN_THEN",
  "TOKEN_ELSE", "TOKEN_FROM", "TOKEN_UNTIL", "TOKEN_LOOP",
  "TOKEN_IDENTIFIER", "TOKEN_NUMBER", "TOKEN_STRING", "TOKEN_ASSIGN",
  "TOKEN_PLUS", "TOKEN_MINUS", "TOKEN_MULT", "TOKEN_DIV", "TOKEN_EQ",
  "TOKEN_LT", "TOKEN_GT", "TOKEN_LE", "TOKEN_GE", "TOKEN_LPAREN",
  "TOKEN_RPAREN", "TOKEN_SEMI", "TOKEN_COMMA", "TOKEN_COLON", "TOKEN_DOT",
  "$accept", "input", "token", YY_NULLPTR
};
#endif
